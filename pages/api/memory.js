...
// ✅ Central folder map (with updated folder IDs)
const folderMap = {
  // Root Knowledge Engine folder (inside the shared drive)
  "Knowledge Engine": "0ABKmvBuklL0lUk9PVA",
  // Update others as needed, here is one example:
